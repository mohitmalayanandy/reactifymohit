      ...
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-8 relative z-10">
        ...
        <div className="relative order-1 md:order-none mx-auto md:mx-0 w-full max-w-2xl">
          ...
          <div className={`grid grid-cols-2 gap-4 mt-4 transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-black/70 backdrop-blur-md border border-cyan-900 rounded-xl p-3 group hover:border-cyan-500 transition-colors">
              ...
              <div className="text-xl font-bold text-white">1+ Years</div>
            </div>
        ...
        <div className="text-center md:text-left order-2 md:order-none">
          ...
          <div className={`flex flex-wrap gap-3 mb-8 transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {["MongoDB", "Express", "React.js", "Node.js", "Tailwind", "React Native"].map((tech, index) => (
              <span 
                key={tech} 
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center md:justify-start transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <button
              className="relative bg-gradient-to-r from-cyan-500 to-cyan-600 text-black hover:from-cyan-400 hover:to-cyan-500 px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-medium transition-all duration-300 group overflow-hidden cursor-pointer"
            ...
            <button
              className="relative bg-transparent border border-cyan-500 text-cyan-400 hover:bg-cyan-950 px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-medium transition-all duration-300 cursor-pointer"
            ...
            <button
              className="relative bg-transparent border-0 text-white/70 hover:text-white px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-medium transition-colors duration-300 cursor-pointer"
              aria-label="View Projects">
              <span className="flex items-center gap-1">
                <span onClick={() => navigate("/projects")}>View Projects</span>
